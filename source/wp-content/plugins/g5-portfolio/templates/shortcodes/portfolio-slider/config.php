...
return array(
    'base' => 'g5element_portfolio_slider',
    'name' => esc_html__('Portfolio Slider', 'g5-portfolio'),
    'description' => esc_html__( 'Display slider of portfolio', 'g5-portfolio' ),
    'category' => G5ELEMENT()->shortcode()->get_category_name(),
    'icon'        => 'g5element-vc-icon-portfolio-slider',
    'params' => array_merge(
        array(
            array(
            ...
            array(
                ...
                'description' => esc_html__('Specify your portfolio item skin.', 'g5-portfolio'),
        ...
        g5element_vc_map_add_slider(array(), esc_html__('Slider Options', 'g5-portfolio')),
        array(
            array(
