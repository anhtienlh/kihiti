...
if (!class_exists('G5Services_Admin_Post_Types')) {
    class G5Services_Admin_Post_Types {

        private $permalink = array();
        public $post_type = 'services';
        public $taxonomy_cat = 'services_category';
        public $taxonomy_visibility = 'services_visibility';
        private $ajax_nonce = 'g5services_featured_nonce';
        ...
        public function init() {
            $this->permalink = G5SERVICES()->admin()->permalink()->get_settings();
            ...
            add_action('wp_ajax_g5services_featured', array($this, 'update_services_featured'));
        ...
        public function register_post_types($post_types) {
            $post_types [$this->post_type] = array(
                'label'         => esc_html__('Services', 'g5-services'),
        ...
        public function register_taxonomy($taxonomies) {
            $taxonomies[$this->taxonomy_cat] = array(
                ...
                'label'         => esc_html__('Categories', 'g5-services'),
                'name'          => esc_html__('Services Categories', 'g5-services'),
                'singular_name' => esc_html__('Category', 'g5-services'),
        ...
        public function custom_columns_heading($columns) {
            ...
            $my_columns['thumbnail'] = "<span class='dashicons dashicons-format-image'></span>"; esc_html__('Thumbnail','g5-services');
            $my_columns['title'] = $columns['title'];
            $my_columns['taxonomy-'. $this->taxonomy_cat] = esc_html__('Categories','g5-services');
            $my_columns['g5services-featured'] = "<span class='dashicons dashicons-star-filled parent-tips' title='" . esc_html__('Featured','g5-services') . "' style='cursor: help'></span>";
        ...
        public function custom_columns_content($columns,$post_id) {
            ...
            if($columns === 'g5services-featured') {
                ...
                ?>
                <a href="javascript:;" class="g5services__featured" data-options="<?php echo esc_attr(json_encode($options))?>">
        ...
        public function update_services_featured() {
        ...
        public function add_category_filter() {
            ...
            if ($typenow === $this->post_type) {
                ...
                wp_dropdown_categories(array(
                    'show_option_all' => sprintf(esc_html__('Show All %s', 'g5-services'), $info_taxonomy->label),
                    'taxonomy'        => $taxonomy,
                    'name'            => $taxonomy,
                    'orderby'         => 'name',
                    'selected'        => $selected,
        ...
        public function admin_bar_menus($wp_admin_bar) {
            ...
            $wp_admin_bar->add_node( array(
                'parent' => 'site-name',
                'id'     => 'g5services',
                'title'  => esc_html__('Visit Services','g5-services'),
