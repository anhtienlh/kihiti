...
return array(
    'base' => 'g5element_staff',
    'name' => esc_html__('Staff', 'g5-staff'),
    'description' => esc_html__( 'Display list of staff', 'g5-staff' ),
    'category' => G5ELEMENT()->shortcode()->get_category_name(),
    'icon'        => 'g5element-vc-icon-staff',
    'params' => array_merge(
        array(
            array(
            ...
            array(
                ...
                'heading' => esc_html__('Layout', 'g5-staff'),
                'description' => esc_html__('Specify your staff layout', 'g5-staff'),
                'type' => 'g5element_image_set',
                'value' => G5STAFF()->settings()->get_staff_layout(),
                'std' => 'grid',
                'admin_label' => true
            ),
            array(
            ...
            array(
                ...
                'description' => esc_html__('Specify your horizontal space between portfolio.', 'g5-staff'),
                'type' => 'dropdown',
            ...
            array(
                ...
                'heading' => esc_html__('Paging', 'g5-staff'),
                'description' => esc_html__('Specify your post paging mode', 'g5-staff'),
                'type' => 'dropdown',
            ...
            array(
                ...
                'std'         => '',
                'dependency' => array('element' => 'cate_filter_enable', 'value' => 'on'),
                'description' => esc_html__( 'Change where the group are attached (Selector, htmlString, Array, Element, jQuery object)', 'g5-staff' ),
            ),
