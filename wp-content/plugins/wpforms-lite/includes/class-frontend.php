...
class WPForms_Frontend {
	...
	public function get_strings() {
		...
		// Define base strings.
		$strings = array(
			'val_required'               => wpforms_setting( 'validation-required', esc_html__( 'Nội dung này là bắt buộc nhập.', 'wpforms-lite' ) ),
			'val_url'                    => wpforms_setting( 'validation-url', esc_html__( 'Please enter a valid URL.', 'wpforms-lite' ) ),
			'val_email'                  => wpforms_setting( 'validation-email', esc_html__( 'Địa chỉ Email không chính xác.', 'wpforms-lite' ) ),
